...
public class DisplayAllFlight extends BorderPane {

	public DisplayAllFlight() {
		Label Title = new Label ("                            Display All Flights                                   ") ;
		Title.setFont(new Font (40));
		Title.setStyle("-fx-background-color:#0CBF83;\n" + "-fx-background-radius:40;\n ");
		Button search = new Button ("Display ALL Flights") ;			search.setPrefSize(250 , 60);
...
info.setText(Main.list.DisplayFlight());
});
